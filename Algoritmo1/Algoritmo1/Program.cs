...
namespace Algoritmo1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AlgoritmoTSP tsp = new AlgoritmoTSP(graph, 42, DesembRey);
            AlgoritmoTSP tsp1 = new AlgoritmoTSP(graph, 42, Volantis);
            AlgoritmoTSP tsp2 = new AlgoritmoTSP(graph, 42, Braavos);
            AlgoritmoTSP tsp3 = new AlgoritmoTSP(graph, 42, Qarth);
            AlgoritmoTSP tsp4 = new AlgoritmoTSP(graph, 42, Asshai);
            AlgoritmoTSP tsp5 = new AlgoritmoTSP(graph, 42, Meereen);
            AlgoritmoTSP tsp6 = new AlgoritmoTSP(graph, 42, Pentos);
